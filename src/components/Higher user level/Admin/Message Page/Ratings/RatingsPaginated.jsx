...
import Online from "./RatingsMap";
import ReactPaginate from "react-paginate";
import { Oval } from "react-loader-spinner";

const RatingsPaginated =  ({ books, CDNURL, Loaded, setLoaded, sortInput }) => {
  //*Pagination
  ...
  }, [itemOffset, itemsPerPage, books, setLoaded, sortInput]);
...
export default RatingsPaginated
      ...
      >
        ...
        >
          <div className={`flex flex-col items-start mx-[6.4rem] mt-3 gap-y-3`}>
            <div className="flex">
              <MdMyLocation className="text-lg pr-[2px] pb-4 pt-2 row-span-2 h-full w-[24px]  text-green-600" />
            ...
            <div className="flex">
              <BsCalendar2DateFill className="text-lg pb-3 pt-2 row-span-2 h-full w-[26px] text-green-600" />

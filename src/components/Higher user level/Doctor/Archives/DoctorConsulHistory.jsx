...
const DoctorConsulHistory = ({ CDNURL, user }) => {
  ...
  return (
    <>
      {resched && (
        <ReschedConfirm setResched={setResched} id={bookID} user={user} />
      )}
      <div className="back h-full flex justify-center">
        <div className="w-[70%]">
          ...
          >
            <div className="bg-[#98dd93c4] px-5 pt-5 pb-8 mb-2 rounded-lg items-center gap-x-7 gap-y-4 grid grid-cols-2">

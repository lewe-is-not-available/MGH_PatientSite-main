    ...
    //*if user is not logged in
      ...
      if (errSignUp) {
        ...
        const { error: ErrApp } = await supabase
          ...
          .insert([
            {
              appointee: isSomeone ? Representative : null,
              docname: doc.name,
              fname: formData.Fname,
              lname: formData.Lname,
              mname: formData.Mname,
    ...
    <>
      ...
      <div className="back py-6 px-16">
        <div className="flex fillup justify-center">
          ...
          <div
            data-aos="fade-up"
            className="text-center mt-3 w-[65%] text-[#315E30]"
          >
            ...
            <form
              ...
              className="bg-white p-3 w-full rounded-lg shadow-2xl mt-9"
            >
              {SubmitLoad ? (
                          ...
                          <div className="flex">
                            <p>
                              ...
                              <input
                                ...
                                autoComplete="on"
                                onChange={handleChange}
                                className="outline-none border-2 w-full font-thin px-2 h-9 rounded-lg border-slate-300 focus:border-[#71b967d3]"
                                type="date"
                                required
                              />
                            </p>

    ...
    <div className="Doc_Uniq">
      ...
      >
        ...
        <div className="flex" data-aos="fade-up">
          ...
          <p className="text-base valueDoc">{Doctors.fname} {Doctors.mname} {Doctors.lname}</p>
        </div>
        <div className="flex" data-aos="fade-up">
          <span className="mr-2 font-bold">Specialization: </span>{" "}
          <p className="w-28 text-base valueDoc whitespace-nowrap overflow-hidden overflow-ellipsis">{Doctors.specialization}</p>
        </div>
        <div className="flex" data-aos="fade-up">
          <span className="mr-2 font-bold overflow whitespace-nowrap">Sub-Special: </span>{" "}
          <p className="w-32 text-base valueDoc whitespace-nowrap overflow-hidden overflow-ellipsis">{Doctors.subspecial}</p>
        </div>
        <div className="flex" data-aos="fade-up">
